...
/*初始化IP 将64bit input transfer to permutation_order*/
...
/* 反转IP 将反转后的 64bit of permutation_order 反转回正常状态*/
...
/*Bit-Skeleton Table in E function*/
...
void process_message(unsigned char* message_piece, unsigned char* processed_piece, key_set* key_sets, int mode) {
	...
	/*进行16次 key-dependent computation*/
	int key_index;
	for (k=1; k<=16; k++) {
		memcpy(ln, r, 4);
